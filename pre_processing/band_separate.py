...
for files in os.listdir(sourFile):
    ...
    if files.endswith('.png') == False and files.endswith('.xlsx') == False:
        ...
        for res in os.listdir( tet_files ):
            ...
            if os.path.isdir(os.path.abspath(res)) == True and 'results' in res:
...
#name = '_UTM33N.tif'
#
#sourFile = r'E:\Penghua\data\SST' + '\\' + location[0] + r'\new_selected_data'
#
#os.chdir(sourFile)
#
#for files in os.listdir(sourFile):
