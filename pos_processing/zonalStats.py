...
ax1.set_xlabel('time')
ax1.set_ylabel('Temperature Differences [deg]')
...
fig1.tight_layout()
plt.grid()
fig1.savefig(os.path.join(r'E:\Penghua\results\ComSST\Etna', r'Etna_scf_test_mir.png'), dpi=200)
plt.show()

#zero = numpy.zeros([1,16])
#plt.xticks(range(16), time, rotation=30, fontsize=4)
#p1, = plt.plot(sc_tir[0], 'yo-')
#p2, = plt.plot(sc_tir[1], 'go-')
#p3, = plt.plot(sc_tir[2], 'ro-')
#p4, = plt.plot(sc_tir[3], 'ko-')
#p5, = plt.plot(sc_tir[4], 'co-')
...
#plt.grid()
#plt.savefig(os.path.join(r'E:\Penghua\results\ComSST\Etna', r'Etna_scf_tir.png'), dpi=200)
#plt.show()
...
#p1, = ax1.plot(b_sc, 'ro-')
#ax1.set_title('Best scale factor for each scene')
...
#fig, ax1 = plt.subplots()
#p1, = ax1.plot(b_sc, 'ro-')
#ax1.set_title('Best scale factor for each scene and corresponding $\Delta$T')
#ax1.set_ylabel('best scale factor for each scene', color='r')
#ax1.tick_params('y', colors='r')
#
#ax2 = ax1.twinx()
#p2, = ax2.plot(diff_tem, 'bo--', markerfacecolor='none')
#ax2.set_ylabel('corresponding $\Delta$T [deg]', color='b')
...
#ax1.set_xticks(range(16))
#ax1.set_xticklabels(time, rotation=30, fontsize=5)
#plt.legend([p1,p2,p3], [r'smallest $\Delta$T',r'$\Delta$T for scale factor 1.05','$\Delta$T for scale factor 1.10'],prop={'size':7})
#plt.grid()
#fig2.tight_layout()
