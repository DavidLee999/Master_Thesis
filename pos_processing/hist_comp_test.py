...
#
#n, bins, patches = axes[0].hist(MODISZoneArray[3].compressed(), bins = 100)
#axes[0].axvline(np.mean(MODISZoneArray[3]), color = 'red', linewidth = 0.5)
#axes[0].axvline(np.mean(MODISZoneArray[3])- np.std(MODISZoneArray[3]), color = 'red', linestyle = 'dashed', linewidth = 0.5)
#axes[0].axvline(np.mean(MODISZoneArray[3])+ np.std(MODISZoneArray[3]), color = 'red', linestyle = 'dashed', linewidth = 0.5)
#axes[0].set_title('MODIS', fontsize = 5)
#axes[0].set_xticks(x)
#axes[0].set_xticklabels(x, rotation = 30, fontsize = 5)
#axes[0].set_yticks(range(0, 550, 100))
#axes[0].set_yticklabels(range(0, 550, 100), fontsize = 6)
#axes[0].grid()
#
#n, bins, patches = axes[1].hist(tet100[3].compressed(), bins = 100)
#axes[1].axvline(np.mean(tet100[3]), color = 'red', linewidth = 0.5)
#axes[1].axvline(np.mean(tet100[3])- np.std(tet100[3]), color = 'red', linestyle = 'dashed', linewidth = 0.5)
#axes[1].axvline(np.mean(tet100[3])+ np.std(tet100[3]), color = 'red', linestyle = 'dashed', linewidth = 0.5)
#axes[1].set_title('sub-area 4 with scale factor 1.00', fontsize = 5)
#axes[1].set_xticks(x)
...
#axes[1].grid()
#
#n, bins, patches = axes[2].hist(tet105[3].compressed(), bins = 100)
#axes[2].axvline(np.mean(tet105[3]), color = 'red', linewidth = 0.5)
#axes[2].axvline(np.mean(tet105[3])- np.std(tet105[3]), color = 'red', linestyle = 'dashed', linewidth = 0.5)
#axes[2].axvline(np.mean(tet105[3])+ np.std(tet105[3]), color = 'red', linestyle = 'dashed', linewidth = 0.5)
#axes[2].set_title('sub-area 4 with scale factor 1.05', fontsize = 5)
#axes[2].set_xticks(x)
...
#
#n, bins, patches = axes2[0].hist(tet110[3].compressed(), bins = 100)
#axes2[0].axvline(np.mean(tet110[3]), color = 'red', linewidth = 0.5)
#axes2[0].axvline(np.mean(tet110[3])- np.std(tet110[3]), color = 'red', linestyle = 'dashed', linewidth = 0.5)
#axes2[0].axvline(np.mean(tet110[3])+ np.std(tet110[3]), color = 'red', linestyle = 'dashed', linewidth = 0.5)
#axes2[0].set_title('sub-area 4 with scale factor 1.10', fontsize = 5)
...
#axes2[0].grid()
#
#n, bins, patches = axes2[1].hist(tet115[3].compressed(), bins = 100)
#axes2[1].axvline(np.mean(tet115[3]), color = 'red', linewidth = 0.5)
#axes2[1].axvline(np.mean(tet115[3])- np.std(tet115[3]), color = 'red', linestyle = 'dashed', linewidth = 0.5)
#axes2[1].axvline(np.mean(tet115[3])+ np.std(tet115[3]), color = 'red', linestyle = 'dashed', linewidth = 0.5)
#axes2[1].set_title('sub-area 4 with scale factor 1.15', fontsize = 5)
...
#axes2[1].grid()
#
#n, bins, patches = axes2[2].hist(tet120[3].compressed(), bins = 100)
#axes2[2].axvline(np.mean(tet120[3]), color = 'red', linewidth = 0.5)
#axes2[2].axvline(np.mean(tet120[3])- np.std(tet120[3]), color = 'red', linestyle = 'dashed', linewidth = 0.5)
#axes2[2].axvline(np.mean(tet120[3])+ np.std(tet120[3]), color = 'red', linestyle = 'dashed', linewidth = 0.5)
#axes2[2].set_title('sub-area 4 with scale factor 1.20', fontsize = 5)
...
#fig, axes = plt.subplots(3, 1)
#
#n, bins, patches = axes[0].hist(MODIS, bins = 100)
#axes[0].axvline(np.mean(MODIS), color = 'red', linewidth = 0.5)
#axes[0].axvline(np.mean(MODIS)- np.std(MODIS), color = 'red', linestyle = 'dashed', linewidth = 0.5)
#axes[0].axvline(np.mean(MODIS)+ np.std(MODIS), color = 'red', linestyle = 'dashed', linewidth = 0.5)
#axes[0].set_title('MODIS', fontsize = 5)
#axes[0].set_xticks(x)
#axes[0].set_xticklabels(x, rotation = 30, fontsize = 5)
#axes[0].set_yticks(range(0, 1200, 200))
#axes[0].set_yticklabels(range(0, 1000, 200), fontsize = 6)
#axes[0].grid()
#
#n, bins, patches = axes[1].hist(TET100, bins = 100)
#axes[1].axvline(np.mean(TET100), color = 'red', linewidth = 0.5)
#axes[1].axvline(np.mean(TET100)- np.std(TET100), color = 'red', linestyle = 'dashed', linewidth = 0.5)
#axes[1].axvline(np.mean(TET100)+ np.std(TET100), color = 'red', linestyle = 'dashed', linewidth = 0.5)
#axes[1].set_title('sub-area 4 with scale factor 1.00', fontsize = 5)
#axes[1].set_xticks(x)
#axes[1].set_xticklabels(x, rotation = 30, fontsize = 5)
#axes[1].set_yticks(range(0, 500, 100))
#axes[1].set_yticklabels(range(0, 500, 100), fontsize = 6)
#axes[1].grid()
#
#n, bins, patches = axes[2].hist(TET105, bins = 100)
#axes[2].axvline(np.mean(TET105), color = 'red', linewidth = 0.5)
#axes[2].axvline(np.mean(TET105)- np.std(TET105), color = 'red', linestyle = 'dashed', linewidth = 0.5)
#axes[2].axvline(np.mean(TET105)+ np.std(TET105), color = 'red', linestyle = 'dashed', linewidth = 0.5)
#axes[2].set_title('sub-area 4 with scale factor 1.05', fontsize = 5)
#axes[2].set_xticks(x)
#axes[2].set_xticklabels(x, rotation = 30, fontsize = 5)
#axes[2].set_yticks(range(0, 550, 100))
#axes[2].set_yticklabels(range(0, 550, 100), fontsize = 6)
#axes[2].grid()
#
##plt.xticks(x,rotation = 30, fontsize = 5)
##plt.xlabel('temperature', fontsize = 5)
...
#fig2, axes2 = plt.subplots(3, 1)
#
#n, bins, patches = axes2[0].hist(TET110, bins = 100)
#axes2[0].axvline(np.mean(TET110), color = 'red', linewidth = 0.5)
#axes2[0].axvline(np.mean(TET110)- np.std(TET110), color = 'red', linestyle = 'dashed', linewidth = 0.5)
#axes2[0].axvline(np.mean(TET110)+ np.std(TET110), color = 'red', linestyle = 'dashed', linewidth = 0.5)
#axes2[0].set_title('sub-area 4 with scale factor 1.10', fontsize = 5)
#axes2[0].set_xticks(x)
#axes2[0].set_xticklabels(x, rotation = 30, fontsize = 5)
#axes2[0].set_yticks(range(0, 550, 100))
#axes2[0].set_yticklabels(range(0, 550, 100), fontsize = 6)
#axes2[0].grid()
#
#n, bins, patches = axes2[1].hist(TET115, bins = 100)
#axes2[1].axvline(np.mean(TET115), color = 'red', linewidth = 0.5)
#axes2[1].axvline(np.mean(TET115)- np.std(TET115), color = 'red', linestyle = 'dashed', linewidth = 0.5)
#axes2[1].axvline(np.mean(TET115)+ np.std(TET115), color = 'red', linestyle = 'dashed', linewidth = 0.5)
#axes2[1].set_title('sub-area 4 with scale factor 1.15', fontsize = 5)
#axes2[1].set_xticks(x)
#axes2[1].set_xticklabels(x, rotation = 30, fontsize = 5)
#axes2[1].set_yticks(range(0, 550, 100))
#axes2[1].set_yticklabels(range(0, 550, 100), fontsize = 6)
#axes2[1].grid()
#
#n, bins, patches = axes2[2].hist(TET120, bins = 100)
#axes2[2].axvline(np.mean(TET120), color = 'red', linewidth = 0.5)
#axes2[2].axvline(np.mean(TET120)- np.std(TET120), color = 'red', linestyle = 'dashed', linewidth = 0.5)
#axes2[2].axvline(np.mean(TET120)+ np.std(TET120), color = 'red', linestyle = 'dashed', linewidth = 0.5)
#axes2[2].set_title('sub-area 4 with scale factor 1.20', fontsize = 5)
#axes2[2].set_xticks(x)
#axes2[2].set_xticklabels(x, rotation = 30, fontsize = 5)
#axes2[2].set_yticks(range(0, 550, 100))
#axes2[2].set_yticklabels(range(0, 550, 100), fontsize = 6)
#axes2[2].grid()
#
##plt.xticks(x,rotation = 90, fontsize = 4)
#plt.xlabel('temperature', fontsize = 5)
